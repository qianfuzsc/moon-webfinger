...
This project is maintained by 赵士超 (`qianfuzsc`, `3200329122@qq.com`) at <https://github.com/qianfuzsc/moon-webfinger>. Proposed changes should stay within the documented RFC 7033/JRD scope and must not add implicit network access.
